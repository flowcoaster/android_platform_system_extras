...
//#ifdef WITH_TAINT_TRACKING
    ...
    jlong*      (*GetLongArrayElementsLongArrayElements)(JNIEnvMod*, jlongArray, jboolean*, u4*);
    jfloat*     (*GetLongArrayElementsFloatArrayElements)(JNIEnvMod*, jfloatArray, jboolean*, u4*);
    jdouble*    (*GetLongArrayElementsDoubleArrayElements)(JNIEnvMod*, jdoubleArray, jboolean*, u4*);
...
#define CALL_STATIC_TYPE(_jtype, _jname)                                    \
    ...
    { functions->GetTaintedCharArrayRegion(this, array, start, len, buf, u4* taint); }
